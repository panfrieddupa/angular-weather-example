...
const environmentFileContent = `
  ...
  export const environment = {
    ...
    dataURL: '${process.env.dataURL}',
    xRapidAPIHostName: '${process.env.xRapidAPIHostName}',
    xRapidAPIHostValue: '${process.env.xRapidAPIHostValue}',
    xRapidAPIKeyName: '${process.env.xRapidAPIKeyName}',
    xRapidAPIKeyValue: '${process.env.xRapidAPIKeyValue}'
  };
`;
